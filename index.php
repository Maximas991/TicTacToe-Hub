    ...
    <div class="game-card">
        ...
        <div class="game-scroll">
            <div class="game-card-item">
                <img src="assets/img/game-card/tictactoe.png" alt="TicTacToe Icon">
                <h2>TicTacToe</h2>
            ...
            <div class="game-card-item">
                <img src="assets/img/game-card/memory.png" alt="Memory Game Icon">
                <h2>Memory Game</h2>
            ...
            <div class="game-card-item">
                <img src="assets/img/game-card/snake.png" alt="Snake Game Icon">
                <h2>Snake Game</h2>
